...
class plgSystemJ2Canonical extends JPlugin {
    ...
    public function onAfterRoute(){
        ...
        if($option == 'com_j2store' && in_array($view, array('products','producttags')) && $task == 'view' && $item_id) {
            ...
            $menu_params = $this->getRegistryObject($current_item->params);
            ...
            //find the article id
            $j2prod = F0FTable::getAnInstance('Products','J2StoreTable')->getClone();
            ...
            if($j2prod->j2store_product_id == $j2_product_id){
                ...
                if($view == 'products'){
                    ...
                    if(empty($canonical_item) && $current_url_canonical){
                        ...
                        //$canonical_menu_params = $this->getRegistryObject($canonical_item->params);

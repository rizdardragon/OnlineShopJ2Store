...
<?php if ($options) { ?>
      ...
      <div class="options">
        ...
        <div id="option-<?php echo $option['productoption_id']; ?>" class="option">
          ...
          >
            ...
            <?php endif; ?>
            <?php  echo J2Store::product()->displayPrice($option_value['product_optionvalue_price'], $this->product, $this->params,'products.item.option'); ?>
            )
            <?php } ?>
            </option>
            <?php } ?>
	...
	<br />
        ...
        <br />
        <script type="text/javascript">
          <?php echo J2StoreStrapper::getDateTimePickerScript($element_datetime, $option ['option_params']); ?>
        </script>
        <?php } ?>

...
<?php if($this->params->get('catalog_mode', 0) == 0): ?>
    ...
    <form action="<?php echo $this->product->cart_form_action; ?>"
        ...
        <?php elseif( ( isset($this->product->options) && $cart_type == 2 && count($this->product->options)) || $cart_type == 3 ):?>
            <?php echo J2Store::plugin()->eventWithHtml('BeforeGroupProductLink',array($this->product,$this->params))?>
